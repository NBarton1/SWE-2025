...
export function ScheduleExcelImporter() {
    ...
    return (
        <Stack gap="md">
            ...
            <Text size="sm">Note: Excel headers must be type, homeTeam, awayTeam, date, time</Text>

            {showNotification && (
                <Notification color="green"
                              title="Successfully imported schedule!"
                              onClose={() => setShowNotification(false)}>
                    Close to view the changes.
                </Notification>
            )}
