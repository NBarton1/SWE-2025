...
//
//        every { playerService.createPlayer(req, mockId) } returns playerDTO
//
//        val response = playerController.createPlayer(req, details)
//
//        verify { playerService.createPlayer(req, mockId) }
//
...
//        val playerDTO: PlayerDTO = mockk()
//
//        every { playerService.getPlayers() } returns listOf(playerDTO)
//
